        ...
        <div className="flex items-center justify-between border-b border-slate-200/60 pb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-stone-600 font-body">Update homepage carousel slide imagery, CTA link, or display order</p>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs space-y-5">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                {...register('title')}
                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-xs font-bold text-slate-900 focus:border-amber-500 focus:bg-white focus:outline-none"
              />
