  ...
  const onSubmit = async (data) => {
    try {
      const payload = {
        ...
        minimumOrderAmount: data.minimumOrderAmount != null && !isNaN(data.minimumOrderAmount) ? Number(data.minimumOrderAmount) : null,
        maximumDiscountAmount: data.discountType === 'PERCENTAGE' && data.maximumDiscountAmount != null && !isNaN(data.maximumDiscountAmount) ? Number(data.maximumDiscountAmount) : null,
