        ...
        <div className="flex items-center justify-between h-[44px] px-1.5 max-w-full">
          ...
          <div className="flex items-center">
            <HeaderNotificationDropdown
              ...
              badgeClassName="absolute top-1 right-1 flex h-2 w-2 min-w-[14px] items-center justify-center rounded-full bg-amber-400 px-0.5 font-mono text-[8px] font-bold text-stone-950 border border-[#0f2440] shadow-2xs"
            />
          </div>
        </div>
