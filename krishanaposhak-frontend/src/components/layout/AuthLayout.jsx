...
export default function AuthLayout() {
  return (
    <>
      ...
      <div className="block lg:hidden min-h-screen w-full bg-[#FAF8F5]">
        <Outlet />
      </div>

      {/* ─── DESKTOP LAYOUT (>=1024px - 100% UNCHANGED) ─── */}
      <div className="relative hidden lg:flex min-h-screen overflow-x-hidden bg-[linear-gradient(180deg,#0f2440_0%,#081427_55%,#060e1a_100%)]">
        ...
        <div className="relative flex w-[45%] shrink-0 flex-col items-center justify-center xl:w-[48%]">
          <motion.div
