    ...
    <div className="fixed inset-0 z-40 bg-[#F9F7F4] text-stone-900 font-display antialiased overflow-y-auto lg:hidden pb-28 sm:pb-12">
      ...
      <header className="sticky top-0 z-30 h-[56px] w-full bg-[#F9F7F4]/90 backdrop-blur-xl border-b border-stone-200/80 px-4 sm:px-5 flex items-center justify-between">
        <button
          type="button"
          onClick={() => navigate(-1)}
          className="h-10 w-10 rounded-full bg-white text-stone-800 border border-stone-200/80 flex items-center justify-center active:scale-95 transition-transform shadow-2xs shrink-0"
          aria-label="Back"
        >
        ...
        <Link
          ...
          className="relative h-10 w-10 rounded-full bg-white text-stone-800 border border-stone-200/80 flex items-center justify-center active:scale-95 transition-transform shadow-2xs shrink-0"
          aria-label="Notifications"
        >
          <FiBell className="w-[22px] h-[22px] text-stone-800" />
          {unreadCount > 0 && (
