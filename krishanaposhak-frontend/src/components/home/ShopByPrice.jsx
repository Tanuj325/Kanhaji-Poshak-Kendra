    ...
    <section className="section-padding bg-warm-cream/40 relative">
      <div className="container-page">
        ...
        >
          ...
          <h2 className="mt-2 sm:mt-3 font-heading text-2xl font-extrabold text-amber-950 sm:text-3xl lg:text-4xl">
            Shop By Price Range
          </h2>
        ...
        <div className="grid grid-cols-2 gap-2.5 min-[480px]:gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-5">
          {priceRanges.map((range, index) => {
            ...
            return (
              ...
              >
                <Link
                  to={href}
                  className="group relative flex min-h-[7rem] sm:min-h-[8.5rem] flex-col items-center justify-center rounded-[20px] sm:rounded-[24px] bg-white p-4 sm:p-5 text-center shadow-[0_14px_30px_rgba(44,40,36,0.08)] border border-amber-900/15 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_48px_rgba(44,40,36,0.12)] hover:border-amber-700/40"
                >
                  <span className="absolute -top-2 sm:-top-2.5 rounded-full bg-amber-950 px-2 sm:px-3 py-0.5 text-[9px] sm:text-[10px] font-extrabold text-amber-300 border border-amber-500/30 font-mono shadow-xs">
                    {range.tag}
                  </span>
                  <span className="font-heading text-sm sm:text-base lg:text-lg font-extrabold text-amber-950 mt-2 group-hover:text-amber-800 transition-colors">
                    {range.label}
                  </span>
