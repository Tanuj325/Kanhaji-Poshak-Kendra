...
const FeaturedProducts = memo(function FeaturedProducts() {
    ...
    return (
      <section className="section-padding bg-[#FAF7F2]">
        <div className="container-page">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5">
  ...
  return (
    <section className="section-padding bg-[#FAF7F2] font-display">
      <div className="container-page">
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.2em] text-amber-900 bg-amber-100/80 px-3.5 py-1.5 rounded-full border border-amber-800/20">
          ...
          <Link
            to={ROUTE_PATHS.SHOP}
            className="mt-3.5 inline-flex items-center gap-1 text-xs font-bold uppercase tracking-wider text-amber-900 hover:text-amber-700 transition-colors group"
          >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, margin: '-50px' }}
          className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5"
        >
