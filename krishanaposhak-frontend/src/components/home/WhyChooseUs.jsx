...
const features = [
  {
    icon: (
      <svg className="h-5 w-5 sm:h-7 sm:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: 'Artisanal Meerut weaving traditions passed down through generations.',
  },
  {
    icon: (
      <svg className="h-5 w-5 sm:h-7 sm:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: 'Fast trackable Pan-India delivery for your sacred moments.',
  },
  {
    icon: (
      <svg className="h-5 w-5 sm:h-7 sm:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: 'Hassle-free 7-day exchanges with dedicated support.',
  },
  {
    icon: (
      <svg className="h-5 w-5 sm:h-7 sm:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: 'Finest pure velvet, silk, zari, and durable sacred fabrics.',
  },
];
...
export default function WhyChooseUs() {
  return (
    <section className="py-7 sm:py-16 bg-[linear-gradient(180deg,#0f2440_0%,#081427_100%)]">
