...
const BestSellers = memo(function BestSellers() {
  ...
  return (
    <section className="py-4 lg:py-10 bg-stone-50/60 font-display">
      <div className="container-page">
        ...
        <div className="hidden lg:block">
          <div className="flex items-center justify-between mb-8 text-center px-0">
            <div>
              <span className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-[0.15em] text-temple-gold-dark bg-temple-gold/10 px-3 py-1 rounded-full border border-temple-gold/20">
                <FiAward className="h-3.5 w-3.5" /> Customer Favorites
              </span>
              <h2 className="mt-3 font-display text-3xl lg:text-4xl font-semibold text-dark-charcoal">
                Best Sellers
              </h2>
            </div>
            <Link
