          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-stone-200 bg-stone-50/60 py-2.5 pl-0 pr-2 text-xs font-extrabold text-[#0F2440] placeholder:text-stone-400 focus:border-[#C99A3B] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#C99A3B]/20 transition-all shadow-2xs font-mono [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
